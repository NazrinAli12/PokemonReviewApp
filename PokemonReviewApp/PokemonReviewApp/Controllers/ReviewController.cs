...
public class ReviewController : ControllerBase
{
    ...
    {
        var revies = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviews());
    ...
    public IActionResult GetPokemon(int reviewId)
    {
        ...
        var review = _mapper.Map<ReviewDto>(_reviewRepository.GetReiew(reviewId));
    ...
    public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery] int pokeId, ReviewDto reviewCreate)
    {
        ...
        return Ok("Succesfully Created, Friend ;)");
    ...
    public IActionResult DeleteReview(int reviewId)
    {
        ...
        var reviewToDelete = _reviewRepository.GetReiew(reviewId);
